...
const translations = {
    ko: {
        ...
        'sidebar.learn': 'Learn',
        'sidebar.mentor': '멘토 찾기 (Mentor)',
        'sidebar.mentor.booking': '멘토 예약 (Booking)',
        'sidebar.ai.study': 'AI 스터디 (Study)',
        ...
        'sidebar.admin': 'Admin',
        'sidebar.admin.panel': '분석 (Analytics)',
        'sidebar.admin.mentors': '멘토 관리 (Mentors)',
        'sidebar.quest': '퀘스트 (Quest)',
        'sidebar.theme': '테마 설정 (Theme)',
    ...
    en: {
        ...
        'sidebar.mentor.booking': 'Mentor Booking',
        'sidebar.ai.study': 'AI Study',
        ...
        'sidebar.admin': 'Admin',
        'sidebar.admin.panel': 'Analytics',
        'sidebar.admin.mentors': 'Mentor Management',
        'sidebar.quest': 'Quest',
        'sidebar.theme': 'Theme',
